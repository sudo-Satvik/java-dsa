...
public class D_Rehashing_Optimised_CustomHashmap {
    static class MyHashMap<K, V> {
        ...
        public void put(K key, V val) {     // must take care for insert and update
            ...
            // Rehashing Concept!!!!!!!!!
            if (entries >= buckets.length * DEFAULT_LOADFACTOR){
                rehash();
            }
        }
    ...
    public static void main(String[] args) {
        C_CustomHashmap.MyHashMap<String, Integer> mp = new C_CustomHashmap.MyHashMap<>();
